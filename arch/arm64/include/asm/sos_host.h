...
#ifndef __ARM64_SOS_HOST_H__
#define __ARM64_SOS_HOST_H__
...
//adto placeholder from linux/kvm_host-h
struct kvm_vcpu {
	int adto_placeholder;
//	struct kvm *kvm;
...
//#else
//static inline void sos_hyp_reserve(void) { }
//#endif
