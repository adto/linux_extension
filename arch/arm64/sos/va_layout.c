...
#include <asm/memory.h> //__pa_symbol, vabits_actual

 //#include <cpufeature.h> //cpus_have_const_cap
//
///*
 ...
 */
__init void sos_compute_layout(void)
{
 ...
 */
__init void sos_apply_hyp_relocations(void)
{
	int32_t *rel;
